...
template<typename K, typename T>
using SplayNode = typename SplayTree<K, T>::Node*;

template<typename K, typename T>
template<typename Func>
inline void SplayTree<K, T>::InOrder(Node* _root, Func func)
{
	if (_root != nullptr)
	{
...
template<typename K, typename T>
inline void SplayTree<K, T>::Insert(const K& key, const T& data)
{
	Insert(m_root, key, data);
}

template<typename K, typename T>
inline SplayNode<K, T> SplayTree<K, T>::Find(const K& key)
{
...
template<typename K, typename T>
inline void SplayTree<K, T>::SetParent(Node * child, Node * parent)
{
	if (child != nullptr) {
		child->parent = parent;
	}
...
template<typename K, typename T>
inline void SplayTree<K, T>::KeepParent(Node * node)
{
...
template<typename K, typename T>
inline void SplayTree<K, T>::Rotate(Node * parent, Node * child)
{
...
template<typename K, typename T>
inline SplayNode<K, T> SplayTree<K, T>::Splay(Node * node)
{
...
template<typename K, typename T>
inline std::pair<SplayNode<K, T>, SplayNode<K, T>> SplayTree<K, T>::Split(Node * root, const K & key)
{
	if (root == nullptr) {
...
template<typename K, typename T>
inline SplayNode<K, T> SplayTree<K, T>::Find(Node * node, const K & key)
{
	if (node == nullptr) {
		return nullptr;
	}
...
template<typename K, typename T>
inline void SplayTree<K, T>::Insert(Node * root, const K & key, const T & data)
{
...
template<typename K, typename T>
inline void SplayTree<K, T>::Erase(Node * root, const K & key)
{
	root = Find(root, key);
